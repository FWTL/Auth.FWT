...
namespace Auth.FWT.API.Controllers.Jobs
{
    ...
    {
        private static readonly Dictionary<string, Action<TLAbsMessageMedia>> _switch = new Dictionary<string, Action<TLAbsMessageMedia>>()
        {
        ...
        {
            _switch[media.GetType().FullName](media);
        }
