...
namespace Auth.FWT.API.Controllers.Jobs
{
    ...
    {
        private static readonly Dictionary<string, Func<TLAbsMessageAction, TelegramMessageAction>> _switch = new Dictionary<string, Func<TLAbsMessageAction, TelegramMessageAction>>()
        {
        ...
        {
            return _switch[messageAction.GetType().FullName](messageAction);
        }
    }
}